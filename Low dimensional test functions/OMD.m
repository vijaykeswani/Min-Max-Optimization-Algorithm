...
title(['i = ' num2str(i)], 'FontSize', 30, 'FontName', 'Times','FontWeight', 'normal')
  ...
  % plot(x(t),y(t),z(t)))
   ...
   x1(t+1) = x1(t) - 2*eta*xGrad(x1(t),y1(t)) + eta*xGrad(x1(max(t-1,1)),y1(max(t-1,1)));
   y1(t+1) = y1(t) + 2*eta*yGrad(x1(t),y1(t)) - eta*yGrad(x1(max(t-1,1)),y1(max(t-1,1)));
